...
<body style="background-color: #F2F3F8">
  ...
  <nav class="nav-wrapper fixed" style="display: none ;background-color: #ff6d00">
      ...
      <a href="dashboard.php" class="" id="logo" style="font-size: 19px ; color: black ; margin-left: 10px">Dashboard</a>
...
<div class="container" id="main">
    ...
    <div class="col s12 m12 l8 z-depth-1 " style="background-color: #ffff ; margin-top: 40px;padding: 40px" id="dashboard">
  ...
  <ul class="collapsible expandable" style="border: 0!important;box-shadow: none!important;" id="list">
    ...
    <div class="col s12 l4 hide-on-med-and-down" style="margin-top: 30px;">
      <div class="card">
        <div class="center">
         <img src="user1.png" style=" border: 2px solid aqua; border-radius: 50%; margin-top: 10px;">
          
        </div>
        <div class="card-content">
          <ul>
           <li>Name-vikas sharma</li>
           <li>Contact No-9079831856</li>
           <li>Email-vikas61999@gmail.com</li>
