...
<div class="container" id="main">
    ...
    <div class="col s12 m12 l7 z-depth-1" style="background-color: #ffff ; margin-top: 40px;padding: 40px" id="dashboard">
  ...
  <ul class="collapsible expandable" style="border: 0!important;box-shadow: none!important;" id="list">
     ...
     <div class="col s12 l4 offset-l1 hide-on-med-and-down" style="margin-top: 30px;">
      <div class="card">
        <div class="center" >
