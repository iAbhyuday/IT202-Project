...
<body style="background-color: #F2F3F8">
  ...
  <nav class="nav-wrapper fixed" style="display: none ;background-color: #1565c0">
    ...
    <li class="active"><a href="#">View Status</a></li>
...
<div class="container" id="main">
  ...
  <div class="row ">
   ...
   <div class="col s12 m6 offset-m3 z-depth-1" style="padding: 30px;margin-top: 50px;background-color: white; box-shadow: 5px 5px 25px grey;border: 1px solid #1e88e5;border-radius: 5px;">
